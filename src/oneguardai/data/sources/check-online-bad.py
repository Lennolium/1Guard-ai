...
if __name__ == "__main__":
    input_file_path = "combined_bad/combined_bad.txt"
    output_file_path = "online_domains/output_bad_online.txt"
    output_offline_fp = "offline_domains/output_bad_offline.txt"
...
#
# if __name__ == "__main__":
#     input_file_path = "output/output_bad.txt"
#     output_file_path = "output/output_bad_online.txt"
#     output_offline_fp = "output/output_bad_offline.txt"
#
