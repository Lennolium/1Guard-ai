...
class QueryNotifyPrint(QueryNotify):
    ...
    def __init__(self, result=None, verbose=False, print_all=False,
        ...
        result                 -- Object of type QueryResult() containing
                                  results for this query.
        verbose                -- Boolean indicating whether to give verbose
        output.
        print_all              -- Boolean indicating whether to only print
        all sites, including not found.
        browse                 -- Boolean indicating whether to open found
        sites in a web browser.
    ...
    def countResults(self):
        """This function counts the number of results. Every time the
        function is called,
    ...
    def update(self, result):
        ...
        if result.status == QueryStatus.CLAIMED:
            ...
            raise ValueError(
                    f"Unknown Query Status '{result.status}' for site '"
                    f"{self.result.site_name}'"
                    )
